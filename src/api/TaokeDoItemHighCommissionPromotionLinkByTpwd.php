 ...
 * @url https://open.21ds.cn/index/index/openapi/id/6.shtml?ptype=1
 ...
 * @property String shorturl 是否需要短链接，1为生成，不填则不生成
 * @property String tpwd 是否生成淘口令，1为生成，不填则不生成
 ...
 */
class TaokeDoItemHighCommissionPromotionLinkByTpwd extends BaseCall
{
